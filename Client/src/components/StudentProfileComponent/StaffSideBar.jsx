...
export const StaffSideBar = () => {
  ...
  return (
    <div className={`sidebar ${collapsed ? "collapsed" : ""}`}>
      ...
      <div className="py-2">
        <Link to="/staff-profile" className={`sidebar-link ${isActive("/staff-profile") ? "active" : ""}`}>
          <FaHome className="sidebar-icon" />
          <span className="sidebar-text">Dashboard</span>
        </Link>

        <Link to="/staff-profile/info" className={`sidebar-link ${isActive("/staff-profile/info") ? "active" : ""}`}>
        ...
        <div>
          ...
          {coCurricularOpen && !collapsed && (
            <div className="ps-4">
              <Link
                to="/staff-profile/activity/form"
                className={`sidebar-link ${isActive("/staff-profile/activity/form") ? "active" : ""}`}
              >
              ...
              <Link
                to="/staff-profile/view/participated"
                className={`sidebar-link ${isActive("/staff-profile/view/participated") ? "active" : ""}`}
              >
      ...
      <div className="mt-auto border-top">
        <Link to="/staff-profile/setting" className="sidebar-link">
